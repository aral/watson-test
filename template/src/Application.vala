...
namespace WatsonTest {
    ...
    public class Application : Gtk.Application {
        ...
        public Application () {
            Object(
                application_id: "com.github.aral.watson_test",
                flags: ApplicationFlags.FLAGS_NONE
            );

            saved_state = new GLib.Settings ("com.github.aral.watson_test.saved-state");
            ...
            // on the --help screen.
            set_option_context_summary (_("This is an app for testing Watson with, wot wot!"));
            ...
            // on the --help screen.
            set_option_context_description (_("Copyright ⓒ 2021-present Aral Balkan. Licensed under GNU GPL version 3.0."));
            ...
            handle_local_options.connect((application, options) => {
                ...
                if (options.contains("version")) {
                    print (@"Watson Test $(Constants.Config.VERSION)\n");
